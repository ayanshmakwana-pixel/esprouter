...
# Generate random STA MAC (preserve Espressif OUI 00:4B:12)
mac_bytes = [0x00, 0x4B, 0x12] + [random.randint(0x00, 0xFF) for _ in range(3)]
mac_str = " ".join(f"{b:02X}" for b in mac_bytes)

# Generate random AP MAC (different from STA, same OUI)
ap_mac_bytes = [0x00, 0x4B, 0x12] + [random.randint(0x00, 0xFF) for _ in range(3)]
